...
export default () => {
  ...
  const [budget, setBudget] = useState({ total: 0, anUong: 0, luuTru: 0, diChuyen: 0, khac: 0 });
  ...
  return { destinations, setDestinations, addDestination, updateDestination, deleteDestination, itinerary, setItinerary, budget, setBudget, totalItineraries, setTotalItineraries };
};
